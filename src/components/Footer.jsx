...
export default function Footer() {
  return (
    ...
    <div className='hidden bottom-0 sm:block absolute text-white right-0 h-[5%] w-[15%] bg-primary-red rounded-tl-xl' style={{boxShadow: '-2px -2px 10px #000000'} }>
    ...
    <div className='fixed right-2 bottom-2 text-white sm:hidden'>
    <a href="https://www.instagram.com/" target='_blank'><FaInstagram className='mb-1'/></a>
    <a href="https://www.instagram.com/" target='_blank'><FaLinkedin className='mb-1' /></a>
    <a href="https://www.instagram.com/" target='_blank'><FaYoutube className='mb-1' /></a>
    <a href="https://www.instagram.com/" target='_blank'><FaXTwitter /></a>
    </div>
    </>
  )
}
